...
| [vostride/agent-qa](https://github.com/vostride/agent-qa) | `agent-qa-authoring` — Author and validate natural-language web and mobile QA tests and suites with the source-available Agent QA harness | `npx skills add vostride/agent-qa --skill agent-qa-authoring` |
